...
Justifications :
    Exécution : il y a eu un soucis de version de Java qui a empeché l'exécution du jeu.
                Résolus par la suite rapidement.
...
Justifications :
    Modèle conceptuel : même un peu trop détaillé
...
Justifications :
    Avec tous les choix proposé, plein de scénarios sont possibles
